...
jhu_cases_county <- read_csv("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/web-data/archived_data/data/cases.csv") %>% 
  janitor::clean_names() %>% 
  ...
  sidebarMenu(
    ...
    conditionalPanel(
      ...
      selectInput(
        ...
        choices = c("Male Population" = "Pct_Male",
                    "Female Population" = "Pct_Female",
                    "Married/Couple Population" = "Pct_MarriedCouple",
                    ...
                    "Family Poverty Rate" = "Rate_FamPov",
                    "Incomes to Poverty Ratio: 100%" = "Rate_Poverty100",
                    "Incomes to Poverty Ratio: 200%" = "Rate_Poverty200",
                    "Educational Attainment: Less Than HS" = "Rate_LessThanHS",
                    # "Educational Attainment: Dropout" = "Rate_Dropout",
                    "Coverage Rate: No Health Insurance" = "Rate_NoHealth"),
        selected = "Pct_SingleParent"),
      downloadButton('downloadCSV', label = 'Download Data', style="display: block; margin: 0 auto; width: 200px;color: black;")
      ),
...
body <- dashboardBody(
  ...
  tabItems(
    tabItem(tabName = "dashboard",
            # hr(),
            h2(style="font-weight:800;", "STATEWIDE COVID-19 PROFILE"),
            fluidRow(
            ...
            hr(),
            h2(style="font-weight:800;","COUNTY COVID-19 PROFILE"),
            fluidRow(
              column(width = 6,
