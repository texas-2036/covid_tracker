...
tsa_data <- read_excel("data/dshs/TSA COVID Bed Reports 28 APR (TXSG) (002).xlsx", 
...
tsa_data_vents <- read_excel("data/dshs/TSA COVID Bed Reports 28 APR (TXSG) (002).xlsx", 
...
syndromic_tx <- read_excel("data/dshs/TxS2 Chart April 29 Dashboard.xlsx", sheet="Texas", skip=0) %>%
  clean_names() %>% 
  mutate(date = ymd(date)) %>% 
